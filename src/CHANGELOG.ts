const changelog: Array<any> = [
  {
    ...
    notes: [
      `DOFUS : Ajout d'un bouton pour trier par prix restant asc/desc dans le résumé d'un set`
    ]
  },
  {
    version: '0.16.1',
    releaseDate: '2025-10-06',
    notes: [
      `TODOLIST : Gestion des sauts de ligne dans la description d'une tâche`
    ]
  },
  {
    version: '0.16.0',
